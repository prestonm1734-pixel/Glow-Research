...
const GLOW_PRODUCTS = [
  { name: 'BPC-157', tag: null, cat: 'tissue', purity: '99.8%', badge:null,
    sizes: [
      { mg: '10mg', price: 64.99, list: 80, sku: 'GLO-BC10', image: 'assets/products/bpc-157-10mg-v2.webp' },
    ],
  ...
  { name: 'BPC-157/TB-500', tag: 'Peptide Blend', cat: 'tissue', purity: '99.0%', badge:null,
    sizes: [
      { mg: '10mg', price: 84.99, list: 105, sku: 'GLO-BB10', image: 'assets/products/bpc-157-tb-500-blend-10mg-v2.webp' },
    ],
  ...
  { name: 'GHK-Cu', tag: null, cat: 'tissue', purity: '99.8%', badge:'Best Value',
    sizes: [{ mg: '50mg', price: 54.99, list: 70, sku: 'GLO-CU50', image: 'assets/products/ghk-cu-50mg-v2.webp' }],
  ...
  { name: 'GLOW', tag: 'Peptide Blend', cat: 'tissue', purity: '99.0%', badge:null,
    sizes: [{ mg: '70mg', price: 124.99, list: 155, sku: 'GLO-BBG70', image: 'assets/products/glow-70mg-v2.webp' }],
  ...
  { name: 'CJC-1295 No DAC/Ipamorelin', tag: 'Peptide Blend', cat: 'growth', purity: '99.0%', badge:null,
    sizes: [{ mg: '5/5mg', price: 89.99, list: 110, sku: 'GLO-CP10', image: 'assets/products/cjc-1295-ipamorelin-5-5mg-v2.webp' }],
  ...
  { name: 'Tesamorelin', tag: 'Growth Hormone Secretagogue', cat: 'growth', purity: '99.5%', badge:null,
    sizes: [{ mg: '10mg', price: 98.99, list: 125, sku: 'GLO-TSM10', image: 'assets/products/tesamorelin-10mg-v2.webp' }],
  ...
  { name: 'GLP-1 (SM)', tag: null, cat: 'metabolic', purity: '99.5%', badge:'Popular',
    sizes: [{ mg: '10mg', price: 79.99, list: 100, sku: 'GLO-SM10', image: 'assets/products/glp-1-sm-10mg-v2.webp' }],
  ...
  { name: 'GLP-2 (TR)', tag: null, cat: 'metabolic', purity: '99.4%', badge:null,
    sizes: [{ mg: '10mg', price: 89.99, list: 110, sku: 'GLO-T10', image: 'assets/products/glp-2-tr-10mg-v2.webp' }],
  ...
  { name: 'GLP-3 (RT)', tag: null, cat: 'metabolic', purity: '99.4%', badge:'Best Seller',
    sizes: [
      { mg: '10mg', price: 104.99, list: 130, sku: 'GLO-RT10', image: 'assets/products/retatrutide-10mg-v2.webp' },
    ],
  ...
  { name: 'MOTS-C', tag: null, cat: 'longevity', purity: '99.1%', badge:null,
    sizes: [{ mg: '10mg', price: 74.99, list: 95, sku: 'GLO-MS10', image: 'assets/products/mots-c-10mg-v2.webp' }],
